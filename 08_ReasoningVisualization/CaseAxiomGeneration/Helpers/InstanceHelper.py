...
def create_instance_declaration(name: str, sort: str) -> str:
    result = "tff(inst_" + name + ", type, " + name + " : " + sort + ")." + newline
    return result


def create_inequality_constraints(names: List[str]) -> str:
    result = ""
...
def create_relation_declaration(predicate_name: str, sort1: str, sort2: str, individual1: str, individual2: str):
